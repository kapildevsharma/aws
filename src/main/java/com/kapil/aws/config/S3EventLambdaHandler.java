...
public class S3EventLambdaHandler implements RequestHandler<S3Event, String> {
    private static final Logger logger = LoggerFactory.getLogger(S3EventLambdaHandler.class);
    @Override
    public String handleRequest(S3Event s3event, Context context) {
        try {
            ...
            logger.info("Successfully retrieved {}/{} of type {}", srcBucket, srcKey, headObject.contentType());
            return "Ok";
        } catch (Exception e) {
